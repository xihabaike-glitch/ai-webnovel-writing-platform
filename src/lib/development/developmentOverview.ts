...
const deliveryAuditItems: DevelopmentOverviewAuditItem[] = [
  ...
  },
  {
    ...
    evidence: "开发总览已展示开头、结尾、主干、分支、叶片、土壤六步，并把钩子和土壤作为 验收规则。",
  ...
  },
  {
    ...
    evidence: "参考库已沉淀产品验收闸门、长篇结构主编、中文网文写手、长上下文资料官、海外投稿包装编辑、反馈运营等角色。",
  ...
  },
  {
    ...
    evidence: "总闸门、任务中心、失败修复中心、模型设置和参考库均有 验收焦点；失败中心会在高风险时暂停批量。",
...
const pipelineReceiptFields: DevelopmentOverviewPipelineReceiptField[] = [
  ...
  },
  {
    ...
    ownerConfirmation: "主控闸门 确认可以小批量。",
  },
  {
  ...
  return {
    ...
    items: [
      ...
      },
      {
        ...
        acceptanceSignal: "开头、结尾、主干、分支、叶片、土壤都有可编辑入口、验收规则和章节生产用途。",
        href: "/projects#story-structure",
      },
      {
        id: "model_interfaces",
      ...
      },
      {
        ...
        currentEvidence: "派单中心、任务中心和参考库已把主控闸门、结构主编、中文写手、资料官、海外包装编辑拆成执行角色。",
      ...
      },
      {
        ...
        originalRequest: "按照产品验收闸门路径继续开发，让 AI 写作平台能写作、投稿、复盘，而不是只做计划。",
