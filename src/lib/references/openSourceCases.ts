...
export interface ReferenceCasePlatformCard {
...
const platformExecutionOverrides: Record<
  PlatformId,
  Pick<ReferenceCasePlatformCard, "submissionFocus" | "feedbackMetric" | "nextAction">
> = {
  fanqie: {
...
function buildReferenceCasePlatformCard(id: PlatformId): ReferenceCasePlatformCard {
...
export function buildReferenceCasePlatformScope(): ReferenceCasePlatformScope {
  ...
  return {
    ...
    platformNames,
    platformCards: lockedCorePlatformIds.map(buildReferenceCasePlatformCard),
  };
}
